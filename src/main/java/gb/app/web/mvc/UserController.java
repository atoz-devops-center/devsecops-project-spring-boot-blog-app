package src.main.java.gb.app.web.mvc;

import gb.app.config.security.AppUserDetails;
import gb.app.modules.user.PasswordUpdateValidator;
import gb.app.modules.user.UserService;
import gb.app.modules.user.UserSignupValidator;
import gb.app.modules.user.dto.PasswordUpdateDTO;
import gb.app.modules.user.dto.UserProfileUpdateDTO;
...
public class UserController {
    ...
    public String register(@Valid @ModelAttribute("user") UserSignUpDTO user, BindingResult bindingResult,
        ...
        redirectAttrs.addFlashAttribute("success", "User " + user.getUniqueId() + " is created");
